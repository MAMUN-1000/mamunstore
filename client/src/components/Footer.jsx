...
const SOCIAL_LINKS = [
  {
    name: 'Facebook',
    url: 'https://facebook.com/mamunstoredemo.bd',
    icon: (
  ...
  {
    name: 'Instagram',
    url: 'https://instagram.com/mamunstoredemo.bd',
    icon: (
      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
  ...
  {
    name: 'X (Twitter)',
    url: 'https://x.com/mamunstoredemo.bd',
    icon: (
      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5 text-slate-500 text-[11px]">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>support@mamunstore.bd</span>
            </div>
          </div>
        </div>
      ...
      <div className="border-t border-slate-100 bg-slate-50/70">
        <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[11px] text-slate-400 text-center md:text-right">
            &copy; {new Date().getFullYear()} MamunStore BD. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
